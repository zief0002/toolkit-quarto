...
We will use the [comic-characters.csv](https://raw.githubusercontent.com/zief0002/epsy-8251/master/data/comic-characters.csv) data (see the [data codebook](https://zief0002.github.io/miniature-garbanzo/codebooks/comic-characters.html)) to illustrate how to use several data wrangling functions in order to answer a set of research questions about LGBTQ representation in comics. 
